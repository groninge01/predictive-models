...
def create_betting_df(path):
		...
		betting_cols = ['B365A', 'B365D', 'B365H', 'BWA', 'BWD', 'BWH', 'AHh', 'Avg<2.5', 
										'Avg>2.5', 'AvgA', 'AvgAHA', 'AvgAHH', 'AvgD', 'AvgH', 'Max<2.5', 'Max>2.5', 
										'MaxA', 'MaxAHA', 'MaxAHH', 'MaxD', 'MaxH', 'Day', 'Div', 'IWA', 'IWD', 
										'IWH', 'Month', 'VCA', 'VCD', 'VCH', 'Year', 
...
def create_multiline_df_betting(betting):
		home_col_mapping = {
				'AHh': 'sizeOfHandicap',
				'AvgAHH': 'avAsianHandicapOddsFor',
				'AvgAHA': 'avAsianHandicapOddsAgainst',
				'Avg<2.5': 'avlessthan2.5',
				'Avg>2.5': 'avgreaterthan2.5'
		}
		
		away_col_mapping = {
				'AHh': 'sizeOfHandicap',
				'AvgAHH': 'avAsianHandicapOddsAgainst',
				'AvgAHA': 'avAsianHandicapOddsFor',
				'Avg<2.5': 'avlessthan2.5',
				'Avg>2.5': 'avgreaterthan2.5'
		}
		
		multi_line_odds = (betting[['gameId', 'HomeTeam', 'AHh', 'AvgAHH', 'AvgAHA', 'Avg<2.5', 'Avg>2.5']]
											 .rename(columns=home_col_mapping)
											 .rename(columns={'HomeTeam': 'team'})
											 .append(betting[['gameId', 'AwayTeam', 'AHh', 'AvgAHH', 'AvgAHA', 'Avg<2.5', 'Avg>2.5']]
...
def create_feature_df(df=None):
	...
	features_stats = create_stats_features_ema(stats, span=46)
